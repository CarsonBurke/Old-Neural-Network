...
class NeuralNetwork {
    ...
    clone() {
        ...
        for (let layerName in this.layers) {
            ...
            // Add layer for each layer in this network
            ...
            for (let perceptronName in layer.perceptrons) {
                ...
                // Add perceptrons for each layer to newNetwork's layers

                newNetwork.layers[layerName].addPerceptron()

                // Set newNetwork's new perceptron to this network's perceptron's weights

                newNetwork.layers[layerName].perceptrons[perceptronName].weights = perceptron.weights
            }
        }
